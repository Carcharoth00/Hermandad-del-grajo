      ...
      addPage: function (a, b) {
        ...
        1 <= b &&
          ...
          -1 != navigator.userAgent.indexOf("MSIE 9.0") &&
            e.pageObjs[b].hasClass("cubierta") &&
            e.pageObjs[b].removeClass("cubierta"),
          ...
          for (a in b.pageWrap)
            if (
              ...
              b.pageWrap[a].css({
                ...
                zIndex:
                  (b.pageObjs[a].hasClass("cubierta") ? d.partZ[a] : d.pageZ[a]) ||
                  (c ? -1 : 0),
              }),
              (c = b.pages[a]))
            )
      ...
      init: function (a) {
        this.data({
          f: {
            disabled: !1,
            hover: !1,
            effect: this.hasClass("cubierta") ? "cubierta" : "sheet",
          },
        });
        this.flip("options", a);
